...
- **Plugin:** science-superpowers
- **Author:** K-Dense Inc.
- **Upstream repository:** https://github.com/K-Dense-AI/science-superpowers
- **Vendored from commit:** df2a18e
- **License:** MIT
...
Vendored the 15 methodology skills only; the repo's multi-runtime hooks/scripts (AGENTS.md/GEMINI.md/hooks) are Claude-Code/other-runtime machinery and are not included.
